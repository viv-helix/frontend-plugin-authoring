...
const messages = defineMessages({
  componentsToggleLabel: {
    id: 'course-authoring.course-outline.unit.components-toggle',
    defaultMessage: 'Components',
    description: 'Label for the button that expands/collapses a unit\'s components in the outline',
  },
  loadingComponents: {
