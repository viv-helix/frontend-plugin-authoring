...
import { PUBLISH_TYPES } from 'CourseAuthoring/course-unit/constants';
import { editCourseUnitVisibilityAndData } from 'CourseAuthoring/course-unit/data/thunk';
import MoveModal from 'CourseAuthoring/course-unit/move-modal';
import type { IMoveRequestPayload } from 'CourseAuthoring/course-unit/move-modal/interfaces';
import { formatAccessManagedXBlockData } from 'CourseAuthoring/course-unit/xblock-container-iframe/utils';
import type { FormattedAccessManagedXBlockDataTypes, XBlockTypes } from 'CourseAuthoring/course-unit/xblock-container-iframe/types';
import ConfigureModal from 'CourseAuthoring/generic/configure-modal/ConfigureModal';
import DeleteModal from 'CourseAuthoring/generic/delete-modal/DeleteModal';
import { IframeProvider } from 'CourseAuthoring/generic/hooks/context/iFrameContext';
import { useClipboard } from 'CourseAuthoring/generic/clipboard';
import { ToastContext } from 'CourseAuthoring/generic/toast-context';
import moveModalMessages from 'CourseAuthoring/course-unit/move-modal/messages';
